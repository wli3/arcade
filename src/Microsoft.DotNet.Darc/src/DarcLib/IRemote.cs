...
namespace Microsoft.DotNet.DarcLib
{
    public interface IRemote
    {
        ...
        /// <param name="pullRequestSourceBranch">
        ///     PR base branch (contains the changes desired for @branch).
        ///     If ommitted, will be automatically generated based on targetBranch and a Guid.
        /// </param>
