...
namespace Microsoft.DotNet.DarcLib
{
    internal class LocalGitClient : IGitRepo
    {
        ...
        public Task<string> UpdatePullRequestAsync(
        ...
        public Task GetCommitMapForPathAsync(
            string repoUri,
            string branch,
        ...
        public Task<List<GitFile>> GetCommitsForPathAsync(
            string repoUri,
            string branch,
            string assetsProducedInCommit,
            string pullRequestBaseBranch,
